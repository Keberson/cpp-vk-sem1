...
TEST_F(MatrixClass, sumOnRowVector) {
    std::stringstream str;
    auto tmp = _matrix->sumOn(0, -1, *_vectorHoriz);
...
TEST_F(MatrixClass, sumOnColVector) {
    std::stringstream str;
    auto tmp = _matrix->sumOn(-1, 0, *_vectorVert);
...
TEST_F(MatrixClass, subOnRowVector) {
    std::stringstream str;
    auto tmp = _matrix->subOn(0, -1, *_vectorHoriz);
...
TEST_F(MatrixClass, subOnColVector) {
    std::stringstream str;
    auto tmp = _matrix->subOn(-1, 0, *_vectorVert);
